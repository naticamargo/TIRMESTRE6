...
public class InventarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tennisshop.integracion.jpa.entitis.InventarioPK[ idInventario=" + idInventario + ", proveedorTipoDocumento=" + proveedorTipoDocumento + ", proveedorNumeroDocumento=" + proveedorNumeroDocumento + ", productoIdProducto=" + productoIdProducto + " ]";
    }
