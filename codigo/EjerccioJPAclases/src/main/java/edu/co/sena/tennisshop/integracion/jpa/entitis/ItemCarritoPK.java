...
public class ItemCarritoPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tennisshop.integracion.jpa.entitis.ItemCarritoPK[ productoIdProducto=" + productoIdProducto + ", cARRITOCOMPRASidCARRITO=" + cARRITOCOMPRASidCARRITO + " ]";
    }
