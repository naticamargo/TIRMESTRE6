...
public class InventarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.entity.jpa.InventarioPK[ idInventario=" + idInventario + ", proveedorTipoDocumento=" + proveedorTipoDocumento + ", proveedorNumeroDocumento=" + proveedorNumeroDocumento + ", productoIdProducto=" + productoIdProducto + " ]";
    }
