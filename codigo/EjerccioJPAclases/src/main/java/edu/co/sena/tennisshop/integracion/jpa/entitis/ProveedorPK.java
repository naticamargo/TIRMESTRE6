...
public class ProveedorPK implements Serializable {
    ...
    public ProveedorPK(String tipoDocumento, String numeroDocumento) {
    ...
    public String toString() {
        return "edu.co.sena.tennisshop.integracion.jpa.entitis.ProveedorPK[ tipoDocumento=" + tipoDocumento + ", numeroDocumento=" + numeroDocumento + " ]";
    }
