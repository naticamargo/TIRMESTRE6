...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT TOTAL, SUBTOTAL, IMPUESTOS, FACTURA_ID_FACTURA FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( TOTAL, SUBTOTAL, IMPUESTOS, FACTURA_ID_FACTURA ) VALUES ( ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET TOTAL = ?, SUBTOTAL = ?, IMPUESTOS = ?, FACTURA_ID_FACTURA = ? WHERE FACTURA_ID_FACTURA = ?";
	 ...
	 */
	protected static final int COLUMN_TOTAL = 1;
	 ...
	 */
	protected static final int COLUMN_IMPUESTOS = 3;
