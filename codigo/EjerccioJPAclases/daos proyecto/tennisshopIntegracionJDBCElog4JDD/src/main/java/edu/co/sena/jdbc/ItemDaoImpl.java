...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT CANTIDAD, VALOR_UNITARIO, VALOR_TOTAL, PRODUCTO_ID_PRODUCTO, PEDIDO_FACTURA_ID_FACTURA FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( CANTIDAD, VALOR_UNITARIO, VALOR_TOTAL, PRODUCTO_ID_PRODUCTO, PEDIDO_FACTURA_ID_FACTURA ) VALUES ( ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET CANTIDAD = ?, VALOR_UNITARIO = ?, VALOR_TOTAL = ?, PRODUCTO_ID_PRODUCTO = ?, PEDIDO_FACTURA_ID_FACTURA = ? WHERE PRODUCTO_ID_PRODUCTO = ? AND PEDIDO_FACTURA_ID_FACTURA = ?";
