...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT ID_USUARIO, CONTRASENA, ROL, ACTIVO FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( ID_USUARIO, CONTRASENA, ROL, ACTIVO ) VALUES ( ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET ID_USUARIO = ?, CONTRASENA = ?, ROL = ?, ACTIVO = ? WHERE ID_USUARIO = ?";
	...
	/** 
	 * Returns all rows from the usuario table that match the criteria 'ACTIVO = :activo'.
	 */
	public Usuario[] findWhereActivoEquals(short activo) throws UsuarioDaoException
	{
