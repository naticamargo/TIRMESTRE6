...
import edu.co.sena.dto.Usuario;
import edu.co.sena.exceptions.UsuarioDaoException;
import edu.co.sena.factory.UsuarioDaoFactory;
...
public class UsuarioDaoSample
{
	...
	public static void findWhereActivoEquals(short activo)
	{
		try {
			UsuarioDao _dao = getUsuarioDao();
			Usuario _result[] = _dao.findWhereActivoEquals(activo);
			for (int i=0; i<_result.length; i++ ) {
				display( _result[i] );
			}
