...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT ID_FACTURA, FECHA_FACTURA, FORMA_PAGO, CUENTA_TIPO_DOCUMENTO, CUENTA_NUMERO_DOCUMENTO FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( ID_FACTURA, FECHA_FACTURA, FORMA_PAGO, CUENTA_TIPO_DOCUMENTO, CUENTA_NUMERO_DOCUMENTO ) VALUES ( ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET ID_FACTURA = ?, FECHA_FACTURA = ?, FORMA_PAGO = ?, CUENTA_TIPO_DOCUMENTO = ?, CUENTA_NUMERO_DOCUMENTO = ? WHERE ID_FACTURA = ?";
	 ...
	 */
	protected static final int COLUMN_CUENTA_TIPO_DOCUMENTO = 4;

	/** 
	 * Index of column CUENTA_NUMERO_DOCUMENTO
	 */
	protected static final int COLUMN_CUENTA_NUMERO_DOCUMENTO = 5;
