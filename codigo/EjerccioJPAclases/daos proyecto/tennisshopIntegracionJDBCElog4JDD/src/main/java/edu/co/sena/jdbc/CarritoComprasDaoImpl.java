...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT idCARRITO, TOTAL, SUBTOTAL, IMPUESTOS FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( idCARRITO, TOTAL, SUBTOTAL, IMPUESTOS ) VALUES ( ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET idCARRITO = ?, TOTAL = ?, SUBTOTAL = ?, IMPUESTOS = ? WHERE idCARRITO = ?";

	/** 
	 * SQL DELETE statement for this table
	 */
	protected final String SQL_DELETE = "DELETE FROM " + getTableName() + " WHERE idCARRITO = ?";

	/** 
	 * Index of column idCARRITO
	 */
	protected static final int COLUMN_ID_C_A_R_R_I_T_O = 1;
	...
	/** 
	 * Index of primary-key column idCARRITO
	 */
	protected static final int PK_COLUMN_ID_C_A_R_R_I_T_O = 1;
	...
	{
		CarritoCompras ret[] = findByDynamicSelect( SQL_SELECT + " WHERE idCARRITO = ?", new Object[] { idCARRITO } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " ORDER BY idCARRITO", null );
	}
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE idCARRITO = ? ORDER BY idCARRITO", new Object[] { idCARRITO } );
	}
	...
	{
		return "tennisshop.carrito_compras";
	}
	...
	{
		dto.setIdCARRITO( rs.getString( COLUMN_ID_C_A_R_R_I_T_O ) );
